...
/*
 * AdminController 클래스의 모든 메서드는 admin으로 로그인 한 경우만 처리 가능함.
...
public class AdminController {
	...
	private void mailSend(Mail mail) {
		...
		try {
			FileInputStream fis = new FileInputStream("D:/20200224/spring/workspace/shop3/src/main/resources/mail.properties");
