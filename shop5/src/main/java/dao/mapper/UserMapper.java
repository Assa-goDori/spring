...
public interface UserMapper {
	...
	@Insert("insert into usersecurity (userid, username, password, birthday, phoneno, postcode, address, email)" + 
	...
	@Update("update usersecurity set username=#{username}, birthday=#{birthday}, phoneno=#{phoneno}, postcode=#{postcode}, address=#{address}, email=#{email} where userid=#{userid}")
